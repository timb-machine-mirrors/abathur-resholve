...
rec {
  ...
  oildev = python27.pkgs.buildPythonPackage rec {
    ...
    buildInputs = with python27.pkgs; [ six typing pytest pytest-shell ] ++ [ python27 readline re2c cmark py-yajl makeWrapper ];
  ...
  pytest-shell = python27.pkgs.buildPythonPackage {
